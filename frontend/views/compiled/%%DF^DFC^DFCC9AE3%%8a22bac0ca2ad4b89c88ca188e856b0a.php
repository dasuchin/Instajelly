<?php /* Smarty version 2.6.25, created on 2012-03-18 17:44:37
	...
	<li>
		...
		<div class="ninja">
			...
			{foreach from=$result->comments->data item=comment}
				<li><a href="#" class="commenter"><img src="{$comment->from->profile_picture}" title="{$comment->from->username}" class="commenter-photo"/></a><div><a href="#" class="commenter">{$comment->from->username}</a> {$comment->text}</div></li>
			{/foreach}
			</ul>
		</div>
	</li>
