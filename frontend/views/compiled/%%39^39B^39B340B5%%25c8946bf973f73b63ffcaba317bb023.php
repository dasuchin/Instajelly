...
{if $more}
<a href="javascript:loadMore(\'{$profile->data->username}\')" id="moarrr" class="button green">more</a>
{/if}', 5, false),)), $this); ?>
...
')" id="moarrr" class="button green">more</a>
<?php endif; ?>