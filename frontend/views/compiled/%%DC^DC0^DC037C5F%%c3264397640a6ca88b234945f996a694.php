...
{if $more}
<a href="javascript:loadMore(\'{$profile->data->username}\'); javascript:bottom()" class="loadmore">More</a>
{/if}', 5, false),)), $this); ?>
...
'); javascript:bottom()" class="loadmore">More</a>
<?php endif; ?>