...
{if $more}
<span id="moarrr">{$profile->data->username}</span>
{/if}', 5, false),)), $this); ?>
...
<span id="moarrr"><?php echo $this->_tpl_vars['profile']->data->username; ?>
</span>
<?php endif; ?>