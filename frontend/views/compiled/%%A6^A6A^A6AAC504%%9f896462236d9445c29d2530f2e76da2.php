<?php /* Smarty version 2.6.25, created on 2012-03-16 05:42:19
         compiled from fromstring:%3Cscript+type%3D%22text/javascript%22+src%3D%22/frontend/views/js/userProfile.js%22%3E%3C/script%3E%0D%0A%0D%0A%3Ch1+id%3D%22instajelly%22%3E%3Ca+href%3D%22/%22%3E%3Cimg+src%3D%22/bento/img/icon-instajelly.png%22+alt%3D%22Instajelly%22+title%3D%22Instajelly%22+width%3D%2275%22+height%3D%2240%22/%3E%3C/h1%3E%0D%0A%0D%0A%7Bblock+identifier%3D%22social%22%7D%0D%0A%0D%0A%3Cul+id%3D%22profile%22%3E%0D%0A%09%3Cli%3E%3Cimg+src%3D%22%7B%24profile-%3Edata-%3Eprofile_picture%7D%22+id%3D%22profile-image%22/%3E%3C/li%3E%0D%0A%09%3Cli%3E%3Ca+href%3D%22%7B%24profile-%3Edata-%3Ewebsite%7D%22+id%3D%22profile-name%22+target%3D%22_blank%22%3E%7B%24profile-%3Edata-%3Eusername%7D%3C/a%3E+%3Cdiv+id%3D%22photo-count%22%3E%7B%24profile-%3Edata-%3Ecounts-%3Emedia%7D%3C/div%3E%3Cbr/%3E%0D%0A%09%09%7Bif+%24profile-%3Edata-%3Ebio%7D%3Cspan+id%3D%22profile-bio%22%3E%7B%24profile-%3Edata-%3Ebio%7D%3C/span%3E%3Cbr/%3E%7B/if%7D%0D%0A%09%09%3Cspan%3E%7B%24profile-%3Edata-%3Ecounts-%3Efollowed_by%7D+followers%3C/span%3E%0D%0A%09%3C/li%3E%0D%0A%3C/ul%3E%0D%0A%0D%0A%3Cul+id%3D%22photos%22%3E%0D%0A%7Bforeach+from%3D%24media-%3Edata+item%3Dresult%7D%0D%0A%09%3Cli%3E%3Ca+href%3D%22%7B%24result-%3Eimages-%3Estandard_resolution-%3Eurl%7D%22%3E%3Cimg+src%3D%22%7B%24result-%3Eimages-%3Elow_resolution-%3Eurl%7D%22+alt%3D%22%22+title%3D%22%7B%24result-%3Ecaption-%3Etext%7D%22/%3E%3C/a%3E%3C/li%3E%0D%0A%7B/foreach%7D%0D%0A%3C/ul%3E%0D%0A%0D%0A%7Bif+%24more%7D%0D%0A%3Ca+href%3D%22javascript:loadMore%28%27%7B%24profile-%3Edata-%3Eusername%7D%27%29%22+id%3D%22moarrr%22+class%3D%22btn+green%22%3Emore%3C/a%3E%0D%0A%7B/if%7D */ ?>
...
<ul id="profile">
	...
	<li><a href="{$profile->data->website}" id="profile-name" target="_blank">{$profile->data->username}</a> <div id="photo-count">{$profile->data->counts->media}</div><br/>
		{if $profile->data->bio}<span id="profile-bio">{$profile->data->bio}</span><br/>{/if}
		<span>{$profile->data->counts->followed_by} followers</span>
	</li>
</ul>
...
<?php echo smarty_function_block(array('identifier' => 'social'), $this);?>
...
" id="profile-name" target="_blank"><?php echo $this->_tpl_vars['profile']->data->username; ?>
		...
		<?php if ($this->_tpl_vars['profile']->data->bio): ?><span id="profile-bio"><?php echo $this->_tpl_vars['profile']->data->bio; ?>
</span><br/><?php endif; ?>
