...
?>
				<li><a href="#" class="commenter"><img src="<?php echo $this->_tpl_vars['comment']->from->profile_picture; ?>
" title="<?php echo $this->_tpl_vars['comment']->from->username; ?>
" class="commenter-photo"/></a><div><a href="#" class="commenter"><?php echo $this->_tpl_vars['comment']->from->username; ?>
