...
<ul id="profile">
	...
	<li><a href="{$profile->data->website}" id="profile-name" target="_blank">{$profile->data->username}</a> <div id="photo-count">{$profile->data->counts}</div><br/>
...
</a> <div id="photo-count"><?php echo $this->_tpl_vars['profile']->data->counts; ?>
</div><br/>
