...
smarty_core_load_plugins(array('plugins' => array(array('function', 'menu', 'fromstring:<div id="footer">
	<ul>
		...
		<li>Instajelly is not endorsed by Instagram.</li>
		<li>{menu identifier="home-beta"}</li>
	</ul>
</div>
...
<div id="footer">
 ...
 2012.</li>
		<li>Instajelly is not endorsed by Instagram.</li>
		<li><?php echo smarty_function_menu(array('identifier' => "home-beta"), $this);?>
</li>
	</ul>
</div>
