...
class Home extends Controller {
	...
	function actionIndex($params='') {
		...
		$latestUsers = $objUsers->getRecentUsers('user', 30);
		$numUsers = $objUsers->getNumUsers('user');
		...
		$this->view->assign('latestUsers', $latestUsers);
		$this->view->assign('userCount', $numUsers);
